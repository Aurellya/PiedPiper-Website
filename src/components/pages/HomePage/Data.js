...
export const homeObjFour = {
  ...
  headline: "Always Try To Improve",
  description:
    "By collecting our client's testimonials, we try to evaluate our products and try to deliver the best version as soon as possible. And we also appreciate the good reviews that the client has given.",
